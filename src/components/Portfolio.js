                    ...
                    <a href="https://recipes-cook-book.herokuapp.com/" target="_blank" rel="noopener noreferrer" className="relative block">
                        <div className="bg-white shadow-md rounded-lg overflow-hidden">
                            ...
                            <div className="px-4 py-4">
                                ...
                                <p className="text-gray-600 mt-2 font-extralight text-sm"> <b>Recipe Book App:</b> This Recipe Book project is a web application
                                    that allows users to browse and save recipes. It uses HTML to
                                    structure the web page, CSS to style the page, and JavaScript to
                    ...
                    <a href="https://example.com" target="_blank" rel="noopener noreferrer" className="relative block">
                        <div className="bg-white shadow-md rounded-lg overflow-hidden">
                            ...
                            <div className="px-4 py-4">
                                ...
                                <p className="text-gray-600 mt-2 font-extralight text-sm"><b>5-day Weather Forecast</b> project is a web application built using HTML, CSS, Javascript, and API. The application allows users to enter a location and view the weather forecast for the next 5 days. The application fetches the weather data using a third-party API and displays it in an easy-to-read format. The user interface is designed using HTML and CSS to make it visually appealing and user-friendly. The application uses Javascript to handle user interactions and API requests. Overall, your 5-day Weather Forecast project provides a useful tool for users to plan their activities based on the weather forecast.</p>
                            </div>
                        </div>
                    </a>
                    <a href="https://note-taker-express-1.herokuapp.com/" target="_blank" rel="noopener noreferrer" className="relative block">
                        <div className="bg-white shadow-md rounded-lg overflow-hidden">
                            ...
                            <div className="px-4 py-4">
                                ...
                                <p className="text-gray-600 mt-2 font-extralight text-sm"><b>Note Taker</b> project is a web application built using Express.js that allows users to create, save, and delete notes. The application has a simple and user-friendly interface that displays all saved notes on the left side of the screen and a form for creating new notes on the right side of the screen. Users can click on any saved note to view its details, edit it, or delete it. The notes are saved in a JSON file on the server-side and can be accessed and modified by the user as needed. Your Note Taker project provides a convenient way for users to keep track of their notes and ideas, and with the use of Express.js, it offers a seamless and efficient user experience.</p>
                            </div>
                        </div>
                    </a>
                    <a href="https://example.com" target="_blank" rel="noopener noreferrer" className="relative block">
                        <div className="bg-white shadow-md rounded-lg overflow-hidden">
                            ...
                            <div className="px-4 py-4">
                                ...
                                <p className="text-gray-600 mt-2 font-extralight text-sm"><b>Password Generator</b> is a web-based application that lets users generate strong and unique passwords using HTML, CSS, and Javascript. The user interface is simple and intuitive, allowing users to choose the length and complexity of the password, including options for uppercase and lowercase letters, numbers, and special characters. The Javascript code generates a random password based on the user's preferences, which can then be copied to the clipboard. Overall, your Password Generator provides a convenient and secure way for users to create strong passwords for their accounts.</p>
                            </div>
                        </div>
                    </a>
                    <a href="https://example.com" target="_blank" rel="noopener noreferrer" className="relative block">
                        <div className="bg-white shadow-md rounded-lg overflow-hidden">
                            <img src={require("../assets/Screenshot_20221101_050440.png")} alt="Project 6" className="w-full h-64 object-cover transition-all duration-300 transform hover:scale-105" />
                            <div className="px-4 py-4">
                                <h2 className="text-xl font-bold text-gray-800">Project 6</h2>
                                <p className="text-gray-600 mt-2 font-extralight text-sm">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                            </div>
                        </div>
                    </a>
                </div>
